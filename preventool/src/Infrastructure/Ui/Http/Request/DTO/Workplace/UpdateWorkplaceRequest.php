...
class UpdateWorkplaceRequest implements RequestDTO
{
     ...
     * @Assert\NotBlank(
     *     allowNull = true,
     *     message = "Missing or invalid request parameter 'contactPhone'."
     * )
     * @Assert\Type(
     *     type="string",
     ...
     * @Assert\NotBlank(
     *     allowNull=true,
     *     message = "Missing or invalid request parameter 'address'."
     * )
     * @Assert\Type(
     *     type="string",
     ...
     * @Assert\NotBlank(
     *     allowNull=true,
     *     message = "Missing or invalid request parameter 'numberOfWorkers'."
     * )
     * @Assert\Type(
     *     type="integer",
